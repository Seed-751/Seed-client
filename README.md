...
6. [⛵️ Project Log](#-Project-Log)
    ...
    - [🔅 Lighthouse Performance 향상](#Lighthouse-Performance-향상)
7. [✨ 프로젝트 후기](#-프로젝트-후기)
...
- 크라우드 펀딩 서비스에서 착안하여 제작하였습니다.
- 아직 유명하지 않아 상대적으로 관심을 받지 못하거나 시작하지 못한 아티스트들에게 기회를 주고 도움이 되었으면 하는 생각이 들었습니다.
- 그래서 음악을 듣고 결제를 통해 후원할 수 있는 프로젝트를 시작했습니다.
...
- Lighthouse Performance 점수를 66점에서 93점으로 향상시켯습니다.
